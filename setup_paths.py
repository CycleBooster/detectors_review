...
kd_bu_results_dir = './results/kd_bu/'
kd_bu_results_gray_dir = './results/kd_bu/gray/'
#-------------------------- detect LID
k_nn = [20, 30, 20, 30]
...
dnr_results_dir = './results/dnr/'
dnr_results_gray_dir = './results/dnr/gray/'
...
#-------------------------- detect SFAD
sfad_results_dir = './results/sfad/'
sfad_results_gray_dir = './results/sfad/gray/'
